...
import 'package:getxexample/generated/json/detail_country_entity_helper.dart';
...
class JsonConvert<T> {
  ...
  static _getFromJson<T>(Type type, data, json) {
    switch (type) {			case DetailCountryEntity:
			return detailCountryEntityFromJson(data as DetailCountryEntity, json) as T;			case DetailCountryConfirmed:
			return detailCountryConfirmedFromJson(data as DetailCountryConfirmed, json) as T;			case DetailCountryRecovered:
			return detailCountryRecoveredFromJson(data as DetailCountryRecovered, json) as T;			case DetailCountryDeaths:
			return detailCountryDeathsFromJson(data as DetailCountryDeaths, json) as T;			case CountryEntity:
  ...
  static _getToJson<T>(Type type, data) {
		switch (type) {			case DetailCountryEntity:
			return detailCountryEntityToJson(data as DetailCountryEntity);			case DetailCountryConfirmed:
			return detailCountryConfirmedToJson(data as DetailCountryConfirmed);			case DetailCountryRecovered:
			return detailCountryRecoveredToJson(data as DetailCountryRecovered);			case DetailCountryDeaths:
			return detailCountryDeathsToJson(data as DetailCountryDeaths);			case CountryEntity:
  ...
  static _fromJsonSingle(String type, json) {
    switch (type) {			case 'DetailCountryEntity':
			return DetailCountryEntity().fromJson(json);			case 'DetailCountryConfirmed':
			return DetailCountryConfirmed().fromJson(json);			case 'DetailCountryRecovered':
			return DetailCountryRecovered().fromJson(json);			case 'DetailCountryDeaths':
			return DetailCountryDeaths().fromJson(json);			case 'CountryEntity':
  ...
  static _getListFromType(String type) {
    switch (type) {			case 'DetailCountryEntity':
			return List<DetailCountryEntity>();			case 'DetailCountryConfirmed':
			return List<DetailCountryConfirmed>();			case 'DetailCountryRecovered':
			return List<DetailCountryRecovered>();			case 'DetailCountryDeaths':
			return List<DetailCountryDeaths>();			case 'CountryEntity':
